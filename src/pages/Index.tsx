...
const Index = () => {
  return (
    <div className="min-h-screen">
      ...
      {/* Newsletter Section */}
      <section className="py-20 px-4 bg-gradient-to-br from-purple-900/30 to-black/50">
        <div className="container mx-auto max-w-4xl text-center">
          <Badge variant="secondary" className="mb-6 text-lg px-6 py-2">
            ✨ Join Our Guild ✨
          </Badge>
          <h2 className="text-4xl font-bold medieval-heading mb-4 text-white">
            Subscribe to Our Newsletter
          </h2>
          <p className="text-xl text-foreground/80 mb-8 max-w-2xl mx-auto">
            Be the first to know about new collections, exclusive discounts, and behind-the-scenes peeks at our crafting process.
          </p>
          
          {/* GoHighLevel Form Embed */}
          <div className="max-w-md mx-auto bg-background/80 backdrop-blur-sm rounded-lg p-6 shadow-xl border border-purple-500/30">
            <iframe
